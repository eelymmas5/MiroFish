            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Describe your simulation or prediction requirements in natural language (e.g., What public opinion trends would emerge if a university revokes a controversial disciplinary action?)"
                  rows="6"
                  :disabled="loading"
                ></textarea>
...
// Start simulation - jump immediately, API calls happen on Process page
const startSimulation = () => {
  ...
  import('../store/pendingUpload.js').then(({ setPendingUpload }) => {
    ...
    // Jump to Process page (use special ID for new project)
    router.push({
      name: 'Process',
